...
public class AddTripPointAPIVolley {
    ...
    public AddTripPointAPIVolley(TripLeadActivity mainActivity) {
    ...
    public void sendPoint(String tripId, double latitude, double longitude, Date datetime, String username) {
        Response.Listener<JSONObject> listener = jsonObject -> {
            ...
            mainActivity.handleAddTripPointSuccess(tripId1, latitude1, longitude1, datetime1, userName);
        };
        ...
        Response.ErrorListener error = volleyError -> {
            ...
            if (volleyError instanceof NoConnectionError) {
                ...
                mainActivity.noNetworkSendPoint();
            }
            else{
                ...
                mainActivity.handleAddTripPointFail(s);
            }
